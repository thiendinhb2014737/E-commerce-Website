<?php
    ...
    if((isset($_POST['dangnhap']))&&($_POST['dangnhap'])){
        ...
        if($result['pass']==$pass && $role==1){
            ...
            header('location: ../Admin/index.php?act=index&per_page=24&page=1');          
        }else if($result['pass']==$pass && $role==0){
            $_SESSION['role']=$role;
            $_SESSION['id_user']=$id;
            $_SESSION['user']=$user;
            $_SESSION['avt']=$avt;
            header('location: ../User/index.php?act=index&per_page=24&page=1');          
        }else{
