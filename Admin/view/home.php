...
<div>
    <div id="header">
        <nav class="container-product ">
            <ul id="product-menu" class="justify-content-center swiper-wrapper">
                <?php
                foreach ($dsdm as $dm) {
                    echo '<li class="swiper-slide"><a href="index.php?act=products&id=' . $dm['id'] . '">' . $dm['tendm'] . '</a></li>';
                }
                ?>
            </ul>
    ...
    <div id="main-content">
        ...
        <div id="products">
            ...
            <!--<div class="headline">
                <h3 class="bg-white">Sản phẩm bán chạy</h3>
            </div>-->
