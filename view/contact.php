<div class="box">
        ...
        <div id="main-content">
            ...
            <div id="content">
                <!-- Chức năng tìm kiếm-->
                <form action="index.php?act=products" id="search-box_lh" method="post">
                    <div class="bg-white">
                        <input type="text" id="search-text_lh" name="kyw" placeholder="Tìm kiếm sản phẩm">
                        <button id="search-btn_lh" type="submit" name="timkiem"><i id="icon-find" class="fa-solid fa-magnifying-glass text-white"></i></button>
                    </div>
                </form>
                <div id="img-sale">
