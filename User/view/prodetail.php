...
<div>
    ...
    <div id="main-content">
        ...
        <div id="content" class="col-2">
            ...
            <div id="../img-sale">
                <img class="col-12" src="../img/spct-img1.png" alt="">
                
                <img class="col-12" src="../img/spct-img2.png" alt="">
                ...
                <img class="col-12" src="../img/spct-img3.png" alt="">
            </div>
